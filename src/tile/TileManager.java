...
public class TileManager {
    ...
    public TileManager(GamePanel gp){
        ...
        this.gp = gp;
        tile = new Tile[50]; // Numero di materiali diversi, aumentare se necessario
    ...
    public void getTileImage() {
        ...
        try {
            ...
            // Placeholder per evitare NullPointerException
            tile[0] = new Tile();
            ...
            tile[39] = new Tile();
            tile[39].image = ImageIO.read(getClass().getResourceAsStream("/tiles/dirt.png"));
            tile[40] = new Tile();
